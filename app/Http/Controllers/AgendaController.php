    ...
    public function getEvents(Request $request)
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'medico_id' => 'required|exists:medicos,id',
            'especialidade' => 'required|string|max:255', // Make sure this is required
        ...
        try {
            $agenda = Agenda::create([
                ...
                'especialidade' => $request->especialidade, // Make sure 'especialidade' is saved
                'data_hora' => Carbon::createFromFormat('Y-m-d\TH:i', $request->data_hora)
            ]);

            $agenda->load('medico'); // Eager load medico to get its name
            ...
            return response()->json([
                ...
                'event' => [
                    ...
                    'extendedProps' => [
                        ...
                        'especialidade' => $agenda->especialidade // Ensure specialty is passed here
                    ],
